...
![Illustration by [Allison Horst](https://github.com/allisonhorst/stats-illustrations)](img/intro/ah_ggplot2_masterpiece.png){fig-align="center" width="80%" fig-alt="Allison Horsts monster illustration of building data masterpiece ith ggplot2 featuring a little Picasso monster :)"}
...
#| include: false
#| eval: false
ggsave("02_concepts_pt1_ex1.png",
...
#| include: false
ggsave("02_concepts_pt1_ex2.png",
